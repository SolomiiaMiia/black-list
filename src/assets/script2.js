    ...
    this.toStringArray = function (encoder) {
        ...
        try {
            ...
            if (strPtr | 0) {
                strings = [];
                while (1) {
                    var str = encoder ? encoder.decodePointer(strPtr) : CP1251PointerToUTF8(strPtr);
                    strings.push(str);
                    while (HEAPU8[strPtr | 0] != 0) strPtr += 1;

                    if (HEAPU8[(strPtr + 1) | 0] == 0) break;
    ...
    this.toArrayOfByteArrays = function (count) {
        ...
        try {
            ...
            for (var i = 0; i < count; i++) {
                ...
                var arrLength = Module.getValue(arraysLengthsPtr + i * EU_INT_SIZE, "i32*");
    ...
    this.free = function () {
        ...
        try {
            for (var i = 0; i < this.count; i++) {
                var pCurPtr = Module.getValue((this.arraysPtr + i * EU_PTR_SIZE) | 0, "i32*");
...
function EUPointerIntArray(array) {
    var pPtr = new EUPointerConstructor(EU_INT_SIZE * array.length, false, null, null);
...
var EU_MODULE_INITIALIZE_ON_LOAD = typeof EU_MODULE_INITIALIZE_ON_LOAD != "undefined" ? EU_MODULE_INITIALIZE_ON_LOAD : true;
...
function EUSignCPModuleInitialize() {
    ...
    setTimeout(function () {
        ...
        try {
            if (typeof EUSignCPModuleInitialized == "function") EUSignCPModuleInitialized(isInitialized);
        } catch (e) { }
    }, 100);
}
...
/* Theese constants are specified by compiler and cannot be changed */
...
if (EU_MAX_DATA_SIZE_MB > EU_MAX_LIBRARY_STACK_MB) {
    throw "The EU_MAX_DATA_SIZE_MB (" + EU_MAX_DATA_SIZE_MB + " MB) constant is too big. Please set it less then " + EU_MAX_LIBRARY_STACK_MB + " MB";
}

if (EU_TOTAL_MEMORY_MB < EU_MAX_LIBRARY_STACK_MB) EU_TOTAL_MEMORY_MB = EU_MAX_LIBRARY_STACK_MB + EU_MEMORY_GROWING_STEP_MB;
if (EU_TOTAL_MEMORY_MB % EU_MEMORY_GROWING_STEP_MB != 0) {
    EU_TOTAL_MEMORY_MB = Math.ceil(EU_TOTAL_MEMORY_MB / EU_MEMORY_GROWING_STEP_MB) * EU_MEMORY_GROWING_STEP_MB;
}
...
var Module = {
    ...
    monitorRunDependencies: function (left) {
        ...
        Module.setStatus(left ? "Підготовка... (" + (this.totalDependencies - left) + "/" + this.totalDependencies + ")" : "Всі завантаження завершено.");
    },
...
var EUSignCP = NewClass(
    ...
    function () { },
    {
        ...
        _GetFileSignTimeInfoSync: function (signIndex, signedFile) {
            ...
            try {
                error = Module.ccall("EUGetFileSignTimeInfo", "number", ["number", "array", "number"], [signIndex, UTF8ToCP1251Array(EUFS.getFilePath(signedFile)), pTimeInfoPtr.ptr]);
            } catch (e) {
        ...
        CheckMaxDataSize: function (data) {
            ...
            if (length > Module.MAX_DATA_SIZE) this.RaiseError(EU_ERROR_BAD_PARAMETER);
        },
        Base64Encode: function (data) {
            ...
            try {
                error = Module.ccall("EUBASE64Encode", "number", ["array", "number", "number"], [data, data.length, strPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        Base64Decode: function (data) {
            ...
            try {
                error = Module.ccall("EUBASE64Decode", "number", ["array", "number", "number"], [StringToCString(data), arrPtr.ptr, arrPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SetJavaStringCompliant: function (compliant) {
            this.stringEncoder = new StringEncoder(this.stringEncoder.charset, compliant);
        },
        SetCharset: function (charset) {
            try {
                var encoder = new StringEncoder(charset, this.stringEncoder.javaCompliant);
        ...
        CreateFileStoreSettings: function () {
            return EndUserFileStoreSettings("/certificates", false, false, false, false, false, false, 3600);
        },
        ...
        SetTSPSettings: function (settings) {
            ...
            try {
                error = Module.ccall("EUSetTSPSettings", "number", ["number", "array", "array"], [IntFromBool(settings.getStamps), StringToCString(settings.address), StringToCString(settings.port)]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SetOCSPSettings: function (settings) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [IntFromBool(settings.useOCSP), IntFromBool(settings.beforeStore), StringToCString(settings.address), StringToCString(settings.port)]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SetCMPSettings: function (settings) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [IntFromBool(settings.useCMP), StringToCString(settings.address), StringToCString(settings.port), UTF8ToCP1251Array(settings.commonName)]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SetLDAPSettings: function (settings) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [IntFromBool(settings.useLDAP), StringToCString(settings.address), StringToCString(settings.port), IntFromBool(settings.anonymous), StringToCString(settings.user), StringToCString(settings.password)]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SetModeSettings: function (settings) {
            ...
            try {
                error = Module.ccall("EUSetModeSettings", "number", ["number"], [IntFromBool(settings.offlineMode)]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SetOCSPAccessInfoModeSettings: function (settings) {
            ...
            try {
                error = Module.ccall("EUSetOCSPAccessInfoModeSettings", "number", ["number"], [IntFromBool(settings.enabled)]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SetOCSPAccessInfoSettings: function (settings) {
            ...
            try {
                error = Module.ccall("EUSetOCSPAccessInfoSettings", "number", ["array", "array", "array"], [UTF8ToCP1251Array(settings.issuerCN), StringToCString(settings.address), StringToCString(settings.port)]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SetRuntimeParameter: function (name, value) {
            ...
            try {
                ...
                error = Module.ccall("EUSetRuntimeParameter", "number", ["array", "number", "number"], [UTF8ToCP1251Array(name), intPtr.ptr, EU_INT_SIZE]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
                intPtr.free();
            }
        ...
        SetOCSPResponseExpireTime: function (expireTime) {
            ...
            try {
                error = Module.ccall("EUSetOCSPResponseExpireTime", "number", ["number"], [expireTime]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SaveCertificate: function (certificate) {
            ...
            try {
                error = Module.ccall("EUSaveCertificate", "number", ["array", "number"], [certificate, certificate.length]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SaveCertificates: function (certificates) {
            ...
            try {
                error = Module.ccall("EUSaveCertificates", "number", ["array", "number"], [certificates, certificates.length]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SaveCertificatesEx: function (certificates, trustedStore) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [certificates, certificates.length, trustedStore ? trustedStore : 0, trustedStore ? trustedStore.length : 0]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SaveCRL: function (isFullCRL, crl) {
            ...
            try {
                error = Module.ccall("EUSaveCRL", "number", ["number", "array", "number"], [IntFromBool(isFullCRL), crl, crl.length]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        GetCertificate: function (issuer, serial, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [UTF8ToCP1251Array(issuer), UTF8ToCP1251Array(serial), asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.lengthPtr : 0]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        GetCertificates: function () {
            ...
            try {
                error = Module.ccall("EUGetCertificates", "number", ["number", "number"], [pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        GetCertificatesByKeyInfo: function (keyInfo, cmpServers) {
            ...
            try {
                error = Module.ccall("EUGetCertificatesByKeyInfo", "number", ["array", "number", "array", "array", "number", "number"], [keyInfo, keyInfo.length, addressesArray, portsArray, pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ParseCertificate: function (certificate) {
            ...
            try {
                error = Module.ccall("EUParseCertificate", "number", ["array", "number", "number"], [certificate, certificate.length, infoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ParseCertificateEx: function (certificate) {
            ...
            try {
                error = Module.ccall("EUParseCertificateEx", "number", ["array", "number", "number"], [certificate, certificate.length, pPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            var info = new EndUserCertificateInfoEx(infoPtr, this.fieldsEncoder);
        ...
        GetCRInfo: function (request) {
            ...
            try {
                error = Module.ccall("EUGetCRInfo", "number", ["array", "number", "number"], [request, request.length, pPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CheckCertificate: function (certificate) {
            ...
            try {
                error = Module.ccall("EUCheckCertificate", "number", ["array", "number"], [certificate, certificate.length]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        EnumCertificatesEx: function (subjectType, subjectSubType, certKeyType, keyUsage, index) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [subjectType, subjectSubType, certKeyType, keyUsage, index, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            certInfoEx = new EndUserCertificateInfoEx(certInfoExPtr, this.fieldsEncoder);
        ...
        ReadPrivateKeyBinary: function (privateKey, password) {
            ...
            try {
                error = Module.ccall("EUReadPrivateKeyBinary", "number", ["array", "number", "array", "number"], [privateKey, privateKey.length, UTF8ToCP1251Array(password), infoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        GetKeyInfoBinary: function (privateKey, password) {
            ...
            try {
                error = Module.ccall("EUGetKeyInfoBinary", "number", ["array", "number", "array", "number", "number"], [privateKey, privateKey.length, UTF8ToCP1251Array(password), arrPtr.ptr, arrPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        EnumOwnCertificates: function (index) {
            ...
            try {
                error = Module.ccall("EUEnumOwnCertificates", "number", ["number", "number"], [index, pPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        GetOwnCertificate: function (keyType, keyUsage) {
            ...
            while (true) {
                ...
                if (certInfoEx.GetPublicKeyType() == keyType && (certInfoEx.GetKeyUsageType() & keyUsage) == keyUsage) {
                    break;
                }
            ...
            var cert = pThis.GetCertificate(certInfoEx.GetIssuer(), certInfoEx.GetSerial());

            return new EndUserCertificate(certInfoEx, cert);
        },
        GeneratePrivateKey: function (password, uaKeysType, uaDSKeysSpec, useDSKeyAsKEP, uaKEPKeysSpec, internationalKeysType, internationalKeysSpec, userInfo, extKeyUsages) {
            return this.GeneratePrivateKey2(password, uaKeysType, uaDSKeysSpec, useDSKeyAsKEP, uaKEPKeysSpec, internationalKeysType, internationalKeysSpec, 0, userInfo, extKeyUsages);
        },
        GeneratePrivateKey2: function (password, uaKeysType, uaDSKeysSpec, useDSKeyAsKEP, uaKEPKeysSpec, internationalKeysType, rsaKeysSpec, ecdsaKeysSpec, userInfo, extKeyUsages) {
            var error;
        ...
        MakeNewCertificate: function (privateKey, password, uaKeysType, uaDSKeysSpec, useDSKeyAsKEP, uaKEPKeysSpec, internationalKeysType, internationalKeysSpec, newPrivateKeyPassword) {
            this.CheckMaxDataSize(privateKey);
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "array", "number", "array", "number", "number", "number", "number", "number", "number", "number", "number", "number", "array", "number", "number"],
                    [
                        null,
                        privateKey,
                        privateKey.length,
        ...
        ChangeSoftwarePrivateKeyPassword: function (privateKey, oldPassword, newPassword) {
            this.CheckMaxDataSize(privateKey);
            ...
            try {
                error = Module.ccall(
                    ...
                    [privateKey, privateKey.length, UTF8ToCP1251Array(oldPassword), UTF8ToCP1251Array(newPassword), arrPtr.ptr, arrPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        EnumJKSPrivateKeys: function (container, index) {
            ...
            try {
                error = Module.ccall("EUEnumJKSPrivateKeys", "number", ["array", "number", "number", "number"], [container, container.length, index, keyAliasPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        GetJKSPrivateKey: function (container, keyAlias) {
            ...
            try {
                error = Module.ccall(
                    "EUGetJKSPrivateKey",
                    "number",
                    ["array", "number", "array", "number", "number", "number", "number", "number"],
                    [container, container.length, UTF8ToCP1251Array(keyAlias), keyPtr.ptr, keyPtr.lengthPtr, certsCountPtr.ptr, certsPtr.ptr, certsPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            return new EndUserJKSPrivateKey(keyPtr.toArray(), certsPtr.toArrayOfByteArrays(count));
        },
        ChangeOwnCertificatesStatus: function (requestType, revocationReason) {
            var error;

            try {
                error = Module.ccall("EUChangeOwnCertificatesStatus", "number", ["number", "number"], [requestType, revocationReason]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxReadPrivateKeyBinary: function (context, privateKey, password) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [context.GetContext(), privateKey, privateKey.length, UTF8ToCP1251Array(password), pkCtxPtr.ptr, infoPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            var privateKeyContext = new EndUserPrivateKeyContext(pkCtxPtr.toPtr(), new EndUserOwnerInfo(infoPtr.ptr));
            infoPtr.free();
        ...
        CtxGetOwnCertificate: function (privateKeyContext, certKeyType, keyUsage) {
            ...
            try {
                error = Module.ccall("EUCtxGetOwnCertificate", "number", ["number", "number", "number", "number", "number", "number"], [pkCtx, certKeyType, keyUsage, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxEnumOwnCertificates: function (privateKeyContext, index) {
            ...
            try {
                error = Module.ccall("EUCtxEnumOwnCertificates", "number", ["number", "number", "number", "number", "number"], [pkCtx, index, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxEnumPrivateKeyInfo: function (privateKeyContext, index) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [privateKeyContext.GetContext() | 0, index, dwordKeyTypePtr.ptr, dwordKeyUsagePtr.ptr, dwordKeyIDsCountPtr.ptr, keyIDsPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxExportPrivateKeyContainer: function (privateKeyContext, password, keyID, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [privateKeyContext.GetContext(), UTF8ToCP1251Array(password), UTF8ToCP1251Array(keyID), pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxExportPrivateKeyPFXContainer: function (privateKeyContext, password, exportCerts, trustedKeyIDs, keyIDs, asBase64String) {
            var pPtr = EUPointerArray(privateKeyContext.GetContext());
            var error;
            ...
            try {
                ...
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "array", "number", "number", "number", "array", "number", "number"],
                    [privateKeyContext.GetContext(), UTF8ToCP1251Array(password), IntFromBool(exportCerts), keyIDs.length, trustedKeyIDsPtr.ptr, intArrayFromStrings(keyIDs), pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxGetCertificateFromPrivateKey: function (privateKeyContext, keyID) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [privateKeyContext.GetContext(), UTF8ToCP1251Array(keyID), pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            certInfoExPtr = pCertInfoExPtr.toPtr();
            certInfoEx = new EndUserCertificateInfoEx(certInfoExPtr, this.fieldsEncoder);
            Module._EUCtxFreeCertificateInfoEx(privateKeyContext.GetContext() | 0, certInfoExPtr);

            return new EndUserCertificate(certInfoEx, certArrPtr.toArray());
        },
        CtxChangeOwnCertificatesStatus: function (privateKeyContext, requestType, revocationReason) {
            var error;

            try {
                error = Module.ccall("EUCtxChangeOwnCertificatesStatus", "number", ["number", "number", "number"], [privateKeyContext.GetContext(), requestType, revocationReason]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxGetOwnEUserParams: function (privateKeyContext) {
            ...
            try {
                error = Module.ccall("EUCtxGetOwnEUserParams", "number", ["number", "number"], [privateKeyContext.GetContext(), pPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxModifyOwnEUserParams: function (privateKeyContext, phone, email) {
            ...
            try {
                error = Module.ccall("EUCtxModifyOwnEUserParams", "number", ["number", "array", "array"], [privateKeyContext.GetContext(), UTF8ToCP1251Array(phone), UTF8ToCP1251Array(email)]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxMakeDeviceCertificate: function (privateKeyContext, deviceName, uaRequest, uaKEPRequest, internationalRequest, ecdsaRequest, cmpAddress, cmpPort) {
            var pkCtx = privateKeyContext.GetContext();
            var uaCertPtr = null,
                uaKEPCertPtr = null,
                intCertPtr = null,
        ...
        CtxMakeNewOwnCertificateWithCR: function (privateKeyContext, uaRequest, uaKEPRequest, rsaRequest, ecdsaRequest) {
            var pkCtx = privateKeyContext.GetContext();
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", uaRequest != null ? "array" : "number", "number", uaKEPRequest != null ? "array" : "number", "number", rsaRequest != null ? "array" : "number", "number", ecdsaRequest != null ? "array" : "number", "number"],
                    [
                        pkCtx,
                        uaRequest != null ? uaRequest : 0,
                        uaRequest != null ? uaRequest.length : 0,
        ...
        HashData: function (data, asBase64String) {
            ...
            try {
                error = Module.ccall("EUHashData", "number", ["array", "number", "number", "number", "number"], [data, data.length, asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.lengthPtr : 0]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxHashData: function (context, hashAlgo, certificate, data, asBase64String) {
            if (typeof data == "string") data = this.StringToArray(data);
        ...
        CtxHashDataBegin: function (context, hashAlgo, certificate) {
            ...
            try {
                error = Module.ccall(
                    "EUCtxHashDataBegin",
                    "number",
                    ["number", "number", certificate != null ? "array" : "number", "number", "number"],
                    [context.GetContext(), hashAlgo, certificate != null ? certificate : 0, certificate != null ? certificate.length : 0, hashCtxPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxHashDataContinue: function (hashContext, data) {
            ...
            try {
                error = Module.ccall("EUCtxHashDataContinue", "number", ["number", "array", "number"], [hashContext.GetContext(), data, data.length]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxHashDataEnd: function (hashContext, asBase64String) {
            ...
            try {
                error = Module.ccall("EUCtxHashDataEnd", "number", ["number", "number", "number"], [hashContext.GetContext(), pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxHashFile: function (context, hashAlgo, certificate, file, onSuccess, onError, asBase64String) {
            var pThis = this;
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    error = Module.ccall(
                        "EUCtxHashFile",
                        "number",
                        ["number", "number", certificate != null ? "array" : "number", "number", "array", "number", "number"],
                        [context.GetContext(), hashAlgo, certificate != null ? certificate : 0, certificate != null ? certificate.length : 0, UTF8ToCP1251Array(EUFS.getFilePath(file)), pPtr.ptr, pPtr.lengthPtr]
                    );
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                }
                ...
                try {
                    var data = asBase64String ? pThis.Base64Encode(pPtr.toArray()) : pPtr.toArray();
                    setTimeout(function () {
                        onSuccess(data);
                    }, 1);
                } catch (e) {
                ...
                var _onSuccess = function (fileReaded) {
                    try {
                        var data = pThis.CtxHashData(context, hashAlgo, certificate, fileReaded.data, asBase64String);
        ...
        CheckDataStruct: function (data) {
            ...
            try {
                error = Module.ccall("EUCheckDataStruct", "number", ["array", "number"], [data, data.length]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CheckFileStruct: function (file, onSuccess, onError) {
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    error = Module.ccall("EUCheckFileStruct", "number", ["array"], [UTF8ToCP1251Array(EUFS.getFilePath(file))]);
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                }
        ...
        GetSignType: function (signIndex, sign) {
            ...
            try {
                error = Module.ccall(
                    "EUGetSignType",
                    "number",
                    ["number", isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number"],
                    [signIndex, isSignStr ? StringToCString(sign) : 0, !isSignStr ? sign : 0, !isSignStr ? sign.length : 0, intPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        GetFileSignType: function (signIndex, signedFile, onSuccess, onError) {
            var pThis = this;
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    error = Module.ccall("EUGetFileSignType", "number", ["number", "array", "number"], [signIndex, UTF8ToCP1251Array(EUFS.getFilePath(signedFile)), intPtr.ptr]);
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                }
                ...
                var _onSuccess = function (fileReaded) {
                    try {
                        var signType = pThis.GetSignType(signIndex, fileReaded.data);
                        onSuccess(signType);
                    } catch (e) {
                        onError(e);
                    }
        ...
        IsDataInSignedDataAvailable: function (sign) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    [isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number"],
                    [isSignStr ? StringToCString(sign) : 0, !isSignStr ? sign : 0, !isSignStr ? sign.length : 0, intPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        GetDataFromSignedData: function (signedData) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    [isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number", "number"],
                    [isSignStr ? StringToCString(signedData) : 0, !isSignStr ? signedData : 0, !isSignStr ? signedData.length : 0, arrPtr.ptr, arrPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        GetSignTimeInfo: function (signIndex, sign) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number"],
                    [signIndex, isSignStr ? StringToCString(sign) : 0, !isSignStr ? sign : 0, !isSignStr ? sign.length : 0, pTimeInfoPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SignData: function (data, asBase64String) {
            ...
            try {
                error = Module.ccall("EUSignData", "number", ["array", "number", "number", "number", "number"], [data, data.length, asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.lengthPtr : 0]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        VerifyData: function (data, sign) {
            ...
            try {
                error = Module.ccall(
                    "EUVerifyData",
                    "number",
                    ["array", "number", isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number"],
                    [data, data.length, isSignStr ? StringToCString(sign) : 0, !isSignStr ? sign : 0, !isSignStr ? sign.length : 0, infoPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        VerifyDataOnTimeEx: function (data, signIndex, sign, onTime, offline, noCRL) {
            if (typeof data == "string") data = this.StringToArray(data);
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["array", "number", "number", isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number", "number", "number", "number"],
                    [data, data.length, signIndex, isSignStr ? StringToCString(sign) : 0, !isSignStr ? sign : 0, !isSignStr ? sign.length : 0, onTime != null ? onTimePtr.ptr : 0, IntFromBool(offline), IntFromBool(noCRL), infoPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SignDataInternal: function (appendCert, data, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [IntFromBool(appendCert), data, data.length, asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.lengthPtr : 0]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        VerifyDataInternal: function (sign) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    [isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number", "number", "number"],
                    [isSignStr ? StringToCString(sign) : 0, !isSignStr ? sign : 0, !isSignStr ? sign.length : 0, arrPtr.ptr, arrPtr.lengthPtr, infoPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        VerifyDataInternalOnTimeEx: function (signIndex, sign, onTime, offline, noCRL) {
            this.CheckMaxDataSize(sign);
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number", "number", "number", "number", "number", "number"],
                    [
                        signIndex,
        ...
        SignHash: function (hash, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    "EUSignHash",
                    "number",
                    [isHashStr ? "array" : "number", !isHashStr ? "array" : "number", "number", "number", "number", "number"],
                    [isHashStr ? StringToCString(hash) : 0, !isHashStr ? hash : 0, !isHashStr ? hash.length : 0, asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.lengthPtr : 0]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        VerifyHash: function (hash, sign) {
            ...
            try {
                error = Module.ccall(
                    "EUVerifyHash",
                    "number",
                    [isHashStr ? "array" : "number", !isHashStr ? "array" : "number", "number", isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number"],
                    [isHashStr ? StringToCString(hash) : 0, !isHashStr ? hash : 0, !isHashStr ? hash.length : 0, isSignStr ? StringToCString(sign) : 0, !isSignStr ? sign : 0, !isSignStr ? sign.length : 0, infoPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        VerifyHashOnTimeEx: function (hash, signIndex, sign, onTime, offline, noCRL) {
            this.CheckMaxDataSize(hash);
            this.CheckMaxDataSize(sign);
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    [isHashStr ? "array" : "number", !isHashStr ? "array" : "number", "number", "number", isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number", "number", "number", "number"],
                    [
        ...
        SignDataRSA: function (data, appendCert, externalSgn, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [data, data.length, IntFromBool(appendCert), IntFromBool(externalSgn), asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.lengthPtr : 0]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        IsDataInSignedFileAvailable: function (signedFile, onSuccess, onError) {
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    error = Module.ccall("EUIsDataInSignedFileAvailable", "number", ["array", "number"], [UTF8ToCP1251Array(EUFS.getFilePath(signedFile)), intPtr.ptr]);
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                }
        ...
        GetDataFromSignedFile: function (signedFile, onSuccess, onError) {
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    error = Module.ccall("EUGetDataFromSignedFile", "number", ["array", "array"], [UTF8ToCP1251Array(EUFS.getFilePath(signedFile)), UTF8ToCP1251Array(EUFS.getFilePath(file))]);
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                }
        ...
        VerifyFileWithExternalSign: function (file, fileWithSign, onSuccess, onError) {
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    error = Module.ccall("EUCheckFileStruct", "number", ["array"], [UTF8ToCP1251Array(EUFS.getFilePath(fileWithSign))]);
                    if (error == EU_ERROR_NONE) {
                        error = Module.ccall("EUVerifyFile", "number", ["array", "array", "number"], [UTF8ToCP1251Array(EUFS.getFilePath(fileWithSign)), UTF8ToCP1251Array(EUFS.getFilePath(file)), infoPtr.ptr]);
                    }
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                }
        ...
        VerifyFileWithInternalSign: function (signedFile, dataFile, onSuccess, onError) {
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    error = Module.ccall("EUCheckFileStruct", "number", ["array"], [UTF8ToCP1251Array(EUFS.getFilePath(signedFile))]);
                    if (error == EU_ERROR_NONE) {
                        error = Module.ccall("EUVerifyFile", "number", ["array", "array", "number"], [UTF8ToCP1251Array(EUFS.getFilePath(signedFile)), UTF8ToCP1251Array(EUFS.getFilePath(file)), infoPtr.ptr]);
                    }
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                }
        ...
        VerifyFileOnTimeEx: function (signIndex, fileWithSign, file, onTime, offline, noCRL, onSuccess, onError) {
            var pThis = this;
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    ...
                    if (error == EU_ERROR_NONE) {
                        error = Module.ccall(
                            ...
                            "number",
                            ["number", "array", "array", "number", "number", "number", "number"],
                            [signIndex, UTF8ToCP1251Array(EUFS.getFilePath(fileWithSign)), UTF8ToCP1251Array(EUFS.getFilePath(dataFile)), onTime != null ? onTimePtr.ptr : 0, IntFromBool(offline), IntFromBool(noCRL), infoPtr.ptr]
                        );
                    }
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                ...
                var data = internal && file != null ? EUFS.readFileAsUint8Array(dataFile) : null;
                ...
                var _onSuccess = function (files) {
                    try {
                        ...
                        if (internal) {
                            info = pThis.VerifyDataInternalOnTimeEx(signIndex, files[0].data, onTime, offline, noCRL);
                            if (file == null) info.data = null;
                        } else {
                            info = pThis.VerifyDataOnTimeEx(files[0].data, signIndex, files[1].data, onTime, offline, noCRL);
                            info.data = null;
                        }
        ...
        CreateEmptySign: function (data, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    "EUCreateEmptySign",
                    "number",
                    [isInternalSign ? "array" : "number", "number", "number", "number", "number"],
                    [isInternalSign ? data : 0, isInternalSign ? data.length : 0, asBase64String ? signPtr.ptr : 0, !asBase64String ? signPtr.ptr : 0, !asBase64String ? signPtr.lengthPtr : 0]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CreateSigner: function (hash, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    [isHashStr ? "array" : "number", !isHashStr ? "array" : "number", "number", "number", "number", "number"],
                    [isHashStr ? StringToCString(hash) : 0, !isHashStr ? hash : 0, !isHashStr ? hash.length : 0, asBase64String ? signerPtr.ptr : 0, !asBase64String ? signerPtr.ptr : 0, !asBase64String ? signerPtr.lengthPtr : 0]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        GetSigner: function (signIndex, sign, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    "EUGetSigner",
                    "number",
                    ["number", isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number", "number", "number"],
                    [signIndex, isSignStr ? StringToCString(sign) : 0, !isSignStr ? sign : 0, !isSignStr ? sign.length : 0, asBase64String ? signerPtr.ptr : 0, !asBase64String ? signerPtr.ptr : 0, !asBase64String ? signerPtr.lengthPtr : 0]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        AppendValidationDataToSigner: function (prevSigner, certificate, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    [isPrevSignerStr ? "array" : "number", !isPrevSignerStr ? "array" : "number", "number", certificate != null ? "array" : "number", "number", "number", "number", "number"],
                    [
        ...
        RawSignData: function (data, asBase64String) {
            ...
            try {
                error = Module.ccall("EURawSignData", "number", ["array", "number", "number", "number", "number"], [data, data.length, asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.ptr : 0, !asBase64String ? pPtr.lengthPtr : 0]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        RawVerifyDataEx: function (cert, data, sign) {
            ...
            try {
                error = Module.ccall(
                    "EURawVerifyDataEx",
                    "number",
                    [cert ? "array" : "numer", "number", "array", "number", isSignStr ? "array" : "number", !isSignStr ? "array" : "number", "number", "number"],
                    [cert != null ? cert : 0, cert != null ? cert.length : 0, data, data.length, isSignStr ? StringToCString(sign) : 0, !isSignStr ? sign : 0, !isSignStr ? sign.length : 0, infoPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxSignHash: function (privateKeyContext, signAlgo, hashContext, appendCert, asBase64String) {
            var pPtr = EUPointerArray(privateKeyContext.GetContext());
            var error;
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "number", "number", "number", "number", "number"],
                    [privateKeyContext.GetContext(), signAlgo, hashContext.GetContext(), IntFromBool(appendCert), pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxVerifyHash: function (hashContext, signIndex, sign) {
            ...
            try {
                error = Module.ccall("EUCtxVerifyHash", "number", ["number", "number", "array", "number", "number"], [hashContext.GetContext(), signIndex, sign, sign.length, infoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxSignHashValue: function (privateKeyContext, signAlgo, hash, appendCert, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    ...
                    [privateKeyContext.GetContext(), signAlgo, hash, hash.length, IntFromBool(appendCert), pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxVerifyHashValue: function (context, hash, signIndex, sign) {
            ...
            try {
                error = Module.ccall("EUCtxVerifyHashValue", "number", ["number", "array", "number", "number", "array", "number", "number"], [context.GetContext(), hash, hash.length, signIndex, sign, sign.length, infoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxSignData: function (privateKeyContext, signAlgo, data, external, appendCert, asBase64String) {
            if (typeof data == "string") data = this.StringToArray(data);
            ...
            try {
                error = Module.ccall(
                    "EUCtxSignData",
                    "number",
                    ["number", "number", "array", "number", "number", "number", "number", "number"],
                    [privateKeyContext.GetContext(), signAlgo, data, data.length, IntFromBool(external), IntFromBool(appendCert), pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxVerifyData: function (context, data, signIndex, sign) {
            ...
            try {
                error = Module.ccall("EUCtxVerifyData", "number", ["number", "array", "number", "number", "array", "number", "number"], [context.GetContext(), data, data.length, signIndex, sign, sign.length, infoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxVerifyDataInternal: function (context, signIndex, sign) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "number", "array", "number", "number", "number", "number"],
                    [context.GetContext(), signIndex, sign, sign.length, arrPtr.ptr, arrPtr.lengthPtr, infoPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxSignFile: function (privateKeyContext, signAlgo, file, external, appendCert, fileWithSign, onSuccess, onError) {
            var pThis = this;
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    error = Module.ccall(
                        ...
                        [privateKeyContext.GetContext(), signAlgo, UTF8ToCP1251Array(EUFS.getFilePath(file)), IntFromBool(external), IntFromBool(appendCert), UTF8ToCP1251Array(EUFS.getFilePath(signFile))]
                    );
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                }
                ...
                var _onSuccess = function (fileReaded) {
                    try {
                        ...
                        signedData = pThis.CtxSignData(privateKeyContext, signAlgo, fileReaded.data, external, appendCert);
        ...
        CtxIsAlreadySigned: function (privateKeyContext, signAlgo, sign) {
            ...
            try {
                error = Module.ccall("EUCtxIsAlreadySigned", "number", ["number", "number", "array", "number", "number"], [privateKeyContext.GetContext(), signAlgo, sign, sign.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxAppendSignHash: function (privateKeyContext, signAlgo, hashContext, previousSign, appendCert, asBase64String) {
            this.CheckMaxDataSize(previousSign);

            if (typeof previousSign == "string") previousSign = this.Base64Decode(previousSign);
            ...
            try {
                error = Module.ccall(
                    "EUCtxAppendSignHash",
                    "number",
                    ["number", "number", "number", "array", "number", "number", "number", "number"],
                    [privateKeyContext.GetContext(), signAlgo, hashContext.GetContext(), previousSign, previousSign.length, IntFromBool(appendCert), pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxAppendSignHashValue: function (privateKeyContext, signAlgo, hash, previousSign, appendCert, asBase64String) {
            this.CheckMaxDataSize(hash);
            this.CheckMaxDataSize(previousSign);
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "number", "array", "number", "array", "number", "number", "number", "number"],
                    [privateKeyContext.GetContext(), signAlgo, hash, hash.length, previousSign, previousSign.length, IntFromBool(appendCert), pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxAppendSign: function (privateKeyContext, signAlgo, data, previousSign, appendCert, asBase64String) {
            if (data != null && typeof data == "string") data = this.StringToArray(data);
            ...
            try {
                error = Module.ccall(
                    "EUCtxAppendSign",
                    "number",
                    ["number", "number", data ? "array" : "number", "number", "array", "number", "number", "number", "number"],
                    [privateKeyContext.GetContext(), signAlgo, data != null ? data : 0, data != null ? data.length : 0, previousSign, previousSign.length, IntFromBool(appendCert), pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxCreateEmptySign: function (context, signAlgo, data, certificate, asBase64String) {
            if (data != null && typeof data == "string") data = this.StringToArray(data);
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "number", data ? "array" : "number", "number", "array", "number", "number", "number"],
                    [context.GetContext(), signAlgo, data != null ? data : 0, data != null ? data.length : 0, certificate, certificate.length, pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxCreateSigner: function (privateKeyContext, signAlgo, hash, asBase64String) {
            this.CheckMaxDataSize(hash);
            ...
            try {
                error = Module.ccall("EUCtxCreateSigner", "number", ["number", "number", "array", "number", "number", "number"], [privateKeyContext.GetContext(), signAlgo, hash, hash.length, pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxAppendSigner: function (context, signAlgo, signer, certificate, previousSign, asBase64String) {
            this.CheckMaxDataSize(signer);
            if (certificate != null) this.CheckMaxDataSize(certificate);
            this.CheckMaxDataSize(previousSign);
            ...
            try {
                error = Module.ccall(
                    "EUCtxAppendSigner",
                    "number",
                    ["number", "number", "array", "number", certificate != null ? "array" : "number", "number", "array", "number", "number", "number"],
                    [context.GetContext(), signAlgo, signer, signer.length, certificate != null ? certificate : 0, certificate != null ? certificate.length : 0, previousSign, previousSign.length, pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxGetSignsCount: function (context, sign) {
            ...
            try {
                error = Module.ccall("EUCtxGetSignsCount", "number", ["number", "array", "number", "number"], [context.GetContext(), sign, sign.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxGetSignerInfo: function (context, signIndex, sign) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "number", "array", "number", "number", "number", "number"],
                    [context.GetContext(), signIndex, sign, sign.length, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxGetFileSignsCount: function (context, signFile, onSuccess, onError) {
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                var error;
                try {
                    error = Module.ccall("EUCtxGetFileSignsCount", "number", ["number", "array", "number"], [context.GetContext(), UTF8ToCP1251Array(EUFS.getFilePath(signFile)), intPtr.ptr]);
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                }
        ...
        CtxGetFileSignerInfo: function (context, signIndex, signFile, onSuccess, onError) {
            var pThis = this;
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    error = Module.ccall(
                        ...
                        [context.GetContext(), signIndex, UTF8ToCP1251Array(EUFS.getFilePath(signFile)), pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]
                    );
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                }
                ...
                var _onSuccess = function (fileReaded) {
                    try {
                        ...
                        signerInfo = pThis.CtxGetSignerInfo(context, signIndex, fileReaded.data);
        ...
        CtxVerifyFile: function (context, signIndex, fileWithSign, file, onSuccess, onError) {
            var pThis = this;
            ...
            if (pThis.isFileSyncAPISupported) {
                ...
                try {
                    ...
                    if (error == EU_ERROR_NONE) {
                        error = Module.ccall(
                            ...
                            [context.GetContext(), signIndex, UTF8ToCP1251Array(EUFS.getFilePath(fileWithSign)), UTF8ToCP1251Array(EUFS.getFilePath(dataFile)), infoPtr.ptr]
                        );
                    }
                } catch (e) {
                    error = EU_ERROR_UNKNOWN;
                ...
                var _onSuccess = function (files) {
                    try {
                        ...
                        if (internal) {
                            info = pThis.CtxVerifyDataInternal(context, signIndex, files[0].data);
                            if (file == null) info.data = null;
                        } else {
                            info = pThis.CtxVerifyData(context, files[0].data, signIndex, files[1].data);
                            info.data = null;
                        }
        ...
        GetTSPByAccessInfo: function (hashAlgo, hash, accessInfo, accessInfoPort, asBase64String) {
            this.CheckMaxDataSize(hash);
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", isHashStr ? "array" : "number", !isHashStr ? "array" : "number", "number", accessInfo ? "array" : "number", accessInfoPort ? "array" : "number", "number", "number"],
                    [
                        hashAlgo,
                        isHashStr ? StringToCString(hash) : 0,
                        !isHashStr ? hash : 0,
        ...
        CheckTSP: function (tsp, hashAlgo, hash) {
            ...
            try {
                error = Module.ccall("EUCheckTSP", "number", ["array", "number", "number", "number", hash ? "array" : "number", "number"], [tsp, tsp.length, hashAlgo, 0, hash ? hash : 0, hash ? hash.length : 0]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        IsEnvelopedData: function (enveloped) {
            ...
            try {
                isEnveloped = Module.ccall("EUIsEnvelopedData", "number", ["array", "number"], [enveloped, enveloped.length]) != EU_FALSE;
                error = EU_ERROR_NONE;
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        EnvelopDataEx: function (recipientCertIssuers, recipientCertSerials, signData, data, asBase64String) {
            if (typeof data == "string") data = this.StringToArray(data);
            ...
            try {
                error = Module.ccall(
                    "EUEnvelopDataEx",
                    "number",
                    ["array", "array", "number", data ? "array" : "number", "number", "number", "number", "number"],
                    [issuers, serials, IntFromBool(signData), data != null ? data : 0, data != null ? data.length : 0, asBase64String ? envDataPtr.ptr : 0, !asBase64String ? envDataPtr.ptr : 0, !asBase64String ? envDataPtr.lengthPtr : 0]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        DevelopData: function (data) {
            ...
            try {
                error = Module.ccall(
                    "EUDevelopData",
                    "number",
                    [isDataStr ? "array" : "number", !isDataStr ? "array" : "number", "number", "number", "number", "number"],
                    [isDataStr ? StringToCString(data) : 0, !isDataStr ? data : 0, !isDataStr ? data.length : 0, devDataPtr.ptr, devDataPtr.lengthPtr, infoPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        EnvelopDataToRecipientsWithDynamicKey: function (recipientCertificates, signData, appendCert, data, asBase64String) {
            if (typeof data == "string") data = this.StringToArray(data);
            ...
            var recipientCertsArray = new EUArrayFromArrayOfArray(recipientCertificates);
            var error;
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "number", "number", "number", "number", "array", "number", "number", "number", "number"],
                    [
        ...
        EnvelopDataRSAEx: function (contentEncAlgoType, recipientCertIssuers, recipientCertSerials, signData, data, asBase64String) {
            if (typeof data == "string") data = this.StringToArray(data);
            ...
            try {
                error = Module.ccall(
                    "EUEnvelopDataRSAEx",
                    "number",
                    ["number", "array", "array", "number", data ? "array" : "number", "number", "number", "number", "number"],
                    [
                        contentEncAlgoType,
                        issuers,
                        serials,
        ...
        CtxEnvelopData: function (privateKeyContext, recipientCertificates, recipientAppendType, signData, appendCert, data, asBase64String) {
            if (typeof data == "string") data = this.StringToArray(data);
            ...
            try {
                error = Module.ccall(
                    "EUCtxEnvelopData",
                    "number",
                    ["number", "number", "number", "number", "number", "number", "number", "array", "number", "number", "number"],
                    [
        ...
        CtxDevelopData: function (privateKeyContext, data, senderCert) {
            ...
            try {
                error = Module.ccall(
                    "EUCtxDevelopData",
                    "number",
                    ["number", isEnvDataStr ? "array" : "number", !isEnvDataStr ? "array" : "number", "number", senderCert ? "array" : "number", "number", "number", "number", "number"],
                    [
                        privateKeyContext.GetContext(),
        ...
        CtxEnvelopDataWithDynamicKey: function (privateKeyContext, recipientCertificates, recipientAppendType, signData, appendCert, data, asBase64String) {
            if (typeof data == "string") data = this.StringToArray(data);
        ...
        CtxGetSenderInfo: function (context, data, recipientCert) {
            ...
            try {
                error = Module.ccall(
                    "EUCtxGetSenderInfo",
                    "number",
                    ["number", "array", "number", "array", "number", "number", "number", "number", "number"],
                    [context.GetContext(), data, data.length, recipientCert, recipientCert.length, isDynamicKeyPtr.ptr, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            return EndUserSenderInfoEx(isDynamicKeyPtr.toBoolean(), certInfoEx, certArrPtr.toArray());
        },
        CtxGetRecipientsCount: function (context, envelopedData) {
            this.CheckMaxDataSize(envelopedData);

            if (typeof envelopedData == "string") envelopedData = this.Base64Decode(envelopedData);

            var intPtr = EUPointerDWORD();
            var error;

            try {
                error = Module.ccall("EUCtxGetRecipientsCount", "number", ["number", "array", "number", "number"], [context.GetContext(), envelopedData, envelopedData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxGetRecipientInfo: function (context, recipientIndex, envelopedData) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "number", "array", "number", "number", "number", "number", "number"],
                    [context.GetContext(), recipientIndex, envelopedData, envelopedData.length, infoTypePtr.ptr, pIssuerPtr.ptr, pSerialPtr.ptr, pPublicKeyIDPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            return EndUserRecipientInfo(infoTypePtr.toNumber(), pIssuerPtr.toString(), pSerialPtr.toString(), pPublicKeyIDPtr.toString());
        },
        //-----------------------------------------------------------------------------
        ClientSessionCreateStep1: function (expireTime) {
            ...
            try {
                error = Module.ccall("EUClientSessionCreateStep1", "number", ["number", "number", "number", "number"], [expireTime, pPtr.ptr, dataPtr.ptr, dataPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ServerSessionCreateStep1: function (expireTime, clientData) {
            ...
            try {
                error = Module.ccall("EUServerSessionCreateStep1", "number", ["number", "array", "number", "number", "number", "number"], [expireTime, clientData, clientData.length, pPtr.ptr, dataPtr.ptr, dataPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ClientSessionCreateStep2: function (session, serverData) {
            ...
            try {
                error = Module.ccall("EUClientSessionCreateStep2", "number", ["number", "array", "number", "number", "number"], [session.GetHandle() | 0, serverData, serverData.length, dataPtr.ptr, dataPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ServerSessionCreateStep2: function (session, clientData) {
            ...
            try {
                error = Module.ccall("EUServerSessionCreateStep2", "number", ["number", "array", "number"], [session.GetHandle() | 0, clientData, clientData.length]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SessionClose: function (session) {
            ...
            try {
                Module.ccall("EUSessionDestroy", "number", ["number"], [session.GetHandle() | 0]);
                error = EU_ERROR_NONE;
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SessionIsInitialized: function (session) {
            ...
            try {
                isInitialized = Module.ccall("EUSessionIsInitialized", "number", ["number"], [session.GetHandle() | 0]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SessionCheckCertificates: function (session) {
            ...
            try {
                error = Module.ccall("EUSessionCheckCertificates", "number", ["number"], [session.GetHandle() | 0]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SessionGetPeerCertificateInfo: function (session) {
            ...
            try {
                error = Module.ccall("EUSessionGetPeerCertificateInfo", "number", ["number", "number"], [session.GetHandle() | 0, infoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SessionSave: function (session) {
            ...
            try {
                error = Module.ccall("EUSessionSave", "number", ["number", "number", "number"], [session.GetHandle() | 0, dataPtr.ptr, dataPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SessionLoad: function (sessionData) {
            ...
            try {
                error = Module.ccall("EUSessionLoad", "number", ["array", "number", "number"], [sessionData, sessionData.length, pPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ClientDynamicKeySessionCreate: function (expireTime, serverCertIssuer, serverCertSerial) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", isCertData ? "number" : "array", isCertData ? "number" : "array", isCertData ? "array" : "number", "number", "number", "number", "number"],
                    [
                        expireTime,
        ...
        ServerDynamicKeySessionCreate: function (expireTime, clientData) {
            ...
            try {
                error = Module.ccall("EUServerDynamicKeySessionCreate", "number", ["number", "array", "number", "number"], [expireTime, clientData, clientData.length, pPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ClientDynamicKeySessionLoad: function (sessionData) {
            ...
            try {
                error = Module.ccall("EUClientDynamicKeySessionLoad", "number", ["array", "number", "number"], [sessionData, sessionData.length, pPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SessionEncrypt: function (session, data, asBase64String) {
            ...
            try {
                error = Module.ccall("EUSessionEncrypt", "number", ["number", "array", "number", "number", "number"], [session.GetHandle() | 0, data, data.length, pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SessionDecrypt: function (session, encryptedData) {
            if (typeof encryptedData == "string") encryptedData = this.Base64Decode(encryptedData);
            ...
            try {
                error = Module.ccall("EUSessionDecrypt", "number", ["number", "array", "number", "number", "number"], [session.GetHandle() | 0, encryptedData, encryptedData.length, pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SessionEncryptContinue: function (session, data, asBase64String) {
            ...
            try {
                error = Module.ccall("EUSessionEncryptContinue", "number", ["number", "number", "number"], [session.GetHandle() | 0, pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        SessionDecryptContinue: function (session, encryptedData) {
            ...
            try {
                error = Module.ccall("EUSessionDecryptContinue", "number", ["number", "number", "number"], [session.GetHandle() | 0, pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxSetParameter: function (context, name, value) {
            ...
            try {
                ...
                error = Module.ccall("EUCtxSetParameter", "number", ["number", "array", "number", "number"], [context.GetContext() | 0, UTF8ToCP1251Array(name), intPtr.ptr, EU_BOOL_SIZE]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
                intPtr.free();
            }
        ...
        ProtectDataByPassword: function (data, password, asBase64String) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["array", "number", password ? "array" : "number", "number", "number", "number"],
                    [data, data.length, password != null ? UTF8ToCP1251Array(password) : 0, asBase64String ? protDataPtr.ptr : 0, !asBase64String ? protDataPtr.ptr : 0, !asBase64String ? protDataPtr.lengthPtr : 0]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        UnprotectDataByPassword: function (data, password, asString) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    [isDataStr ? "array" : "number", !isDataStr ? "array" : "number", "number", password ? "array" : "number", "number", "number"],
                    [isDataStr ? StringToCString(data) : 0, !isDataStr ? data : 0, !isDataStr ? data.length : 0, password != null ? UTF8ToCP1251Array(password) : 0, unprotDataPtr.ptr, unprotDataPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        QRCodeEncode: function (data, scale) {
            ...
            try {
                ...
                var isSuccess = Module.ccall("QRCodeEncode", "number", ["array", "number", "number", "number", "number"], [data, data.length, scale, arrPtr, arrLenPtr]);
                if (isSuccess) {
                    ...
                    imgArray.set(new Uint8Array(Module.HEAPU8.buffer, imgData, imgDataLength));
        ...
        //-----------------------------------------------------------------------------
        AppendTransportHeader: function (caType, fileName, clientEMail, clientCert, data) {
            this.CheckMaxDataSize(data);
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["array", "array", "array", "array", "number", "array", "number", "number", "number"],
                    [UTF8ToCP1251Array(caType), UTF8ToCP1251Array(fileName), UTF8ToCP1251Array(clientEMail), clientCert, clientCert.length, data, data.length, resultDataPtr.ptr, resultDataPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ParseTransportHeader: function (data) {
            ...
            try {
                error = Module.ccall("EUParseTransportHeader", "number", ["array", "number", "number", "number", "number"], [data, data.length, intPtr.ptr, resultDataPtr.ptr, resultDataPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            return new EndUserTransportHeader(intPtr.toNumber(), resultDataPtr.toArray());
        },
        //-----------------------------------------------------------------------------
        AppendCryptoHeader: function (caType, headerType, data) {
            ...
            try {
                error = Module.ccall("EUAppendCryptoHeader", "number", ["array", "number", "array", "number", "number", "number"], [UTF8ToCP1251Array(caType), headerType, data, data.length, resultDataPtr.ptr, resultDataPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ParseCryptoHeader: function (data) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["array", "number", "number", "number", "number", "number", "number"],
                    [data, data.length, caTypePtr.ptr, headerTypePtr.ptr, headerSizePtr.ptr, resultDataPtr.ptr, resultDataPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            return new EndUserCryptoHeader(caType, headerTypePtr.toNumber(), headerSizePtr.toNumber(), resultDataPtr.toArray());
        },
        //-----------------------------------------------------------------------------
        SServerClientSignHashAsync: function (serverAddress, serverPort, clientID, originatorDescription, hashDescription, hash, signAlgorithmName) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["array", isPort ? "array" : "number", "array", originatorDescription ? "array" : "number", "array", isHashStr ? "array" : "number", !isHashStr ? "array" : "number", "number", "array", "number"],
                    [
        ...
        SServerClientCheckSignHashStatus: function (serverAddress, serverPort, clientID, operationID, asBase64String) {
            var isPort = serverPort != null && serverPort != "";
            var pPtr = asBase64String ? EUPointer() : EUPointerArray();
            var error;
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["array", isPort ? "array" : "number", "array", "array", "number", "number", "number"],
                    [
                        UTF8ToCP1251Array(serverAddress),
                        isPort ? UTF8ToCP1251Array(serverPort) : 0,
                        UTF8ToCP1251Array(clientID),
        ...
        SServerClientSignHashesAsync: function (serverAddress, serverPort, clientID, originatorDescription, operationDescription, hashesDescriptions, hashes, signAlgorithmName) {
            var isPort = serverPort != null && serverPort != "";
            var hashesDescr = hashesDescriptions != null ? intArrayFromStrings(hashesDescriptions) : 0;
            var isHashesStr = typeof hashes[0] == "string";
            var hashesValues = isHashesStr ? intArrayFromStrings(hashes) : new EUArrayFromArrayOfArray(hashes);
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["array", isPort ? "array" : "number", "array", originatorDescription ? "array" : "number", "array", hashesDescr ? "array" : "number", isHashesStr ? "array" : "number", "number", "number", "number", "array", "number"],
                    [
                        UTF8ToCP1251Array(serverAddress),
                        isPort ? UTF8ToCP1251Array(serverPort) : 0,
                        UTF8ToCP1251Array(clientID),
        ...
        SServerClientCheckSignHashesStatus: function (serverAddress, serverPort, clientID, operationID) {
            var isPort = serverPort != null && serverPort != "";
            var pPtr = EUPointer();
            var intPtr = EUPointerDWORD();
            var error;
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["array", isPort ? "array" : "number", "array", "array", "number", "number"],
                    [UTF8ToCP1251Array(serverAddress), isPort ? UTF8ToCP1251Array(serverPort) : 0, UTF8ToCP1251Array(clientID), UTF8ToCP1251Array(operationID), pPtr.ptr, intPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            try {
                error = Module.ccall(
                    ...
                    [
                        ...
                        useDSKeyAsKEP ? 1 : 0,
                        uaKEPKeyLength,
                        isIntAlgorithmName ? UTF8ToCP1251Array(internationalAlgorithmName) : 0,
                        internationalKeyLength,
                        pPtr.ptr,
                    ]
                );
        ...
        SServerClientCheckGeneratePrivateKeyStatus: function (serverAddress, serverPort, clientID, operationID) {
            var isPort = serverPort != null && serverPort != "";
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["array", isPort ? "array" : "number", "array", "array", "number", "number", "number", "number", "number", "number", "number", "number", "number"],
                    [
                        UTF8ToCP1251Array(serverAddress),
                        isPort ? UTF8ToCP1251Array(serverPort) : 0,
                        UTF8ToCP1251Array(clientID),
            ...
            var euPrivateKey = new EndUserPrivateKey(null, null, uaReq, uaReqName, uaKEPReq, uaKEPReqName, intReq, intReqName, null, null);
        ...
        ASiCGetASiCType: function (asicData) {
            ...
            if (typeof asicData == "string") asicData = this.Base64Decode(asicData);

            var intPtr = EUPointerDWORD();
            var error;

            try {
                error = Module.ccall("EUASiCGetASiCType", "number", ["array", "number", "number"], [asicData, asicData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCGetSignType: function (asicData) {
            ...
            try {
                error = Module.ccall("EUASiCGetSignType", "number", ["array", "number", "number"], [asicData, asicData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCGetSignsCount: function (asicData) {
            ...
            try {
                error = Module.ccall("EUASiCGetSignsCount", "number", ["array", "number", "number"], [asicData, asicData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCGetSignerInfo: function (signIndex, asicData) {
            ...
            try {
                error = Module.ccall("EUASiCGetSignerInfo", "number", ["number", "array", "number", "number", "number", "number"], [signIndex, asicData, asicData.length, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCGetSignTimeInfo: function (signIndex, asicData) {
            ...
            try {
                error = Module.ccall("EUASiCGetSignTimeInfo", "number", ["number", "array", "number", "number"], [signIndex, asicData, asicData.length, pTimeInfoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCGetSignReferences: function (signIndex, asicData) {
            ...
            try {
                error = Module.ccall("EUASiCGetSignReferences", "number", ["number", "array", "number", "number"], [signIndex, asicData, asicData.length, pPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCGetReference: function (asicData, referenceName) {
            ...
            try {
                error = Module.ccall("EUASiCGetReference", "number", ["array", "number", "array", "number", "number"], [asicData, asicData.length, this.fieldsEncoder.encode(referenceName), arrPtr.ptr, arrPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCSignData: function (asicType, signType, signLevel, references, asBase64String) {
            var refNames = [];
            var refData = [];
            var refDataSize = 0;
            ...
            var refNamesString = intArrayFromStrings(refNames, this.fieldsEncoder);
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "number", "number", "array", "number", "number", "number", "number"],
                    [asicType, signType, signLevel, refNamesString, refDataArray.arraysPtr, refDataArray.arraysLengthPtr, pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCAppendSign: function (signLevel, referencesNames, asicData, asBase64String) {
            this.CheckMaxDataSize(asicData);

            if (typeof asicData == "string") asicData = this.Base64Decode(asicData);

            var refNamesString = referencesNames != null ? intArrayFromStrings(referencesNames, this.fieldsEncoder) : 0;

            var pPtr = EUPointerArray();
            var error;

            try {
                error = Module.ccall("EUASiCAppendSign", "number", ["number", refNamesString ? "array" : "number", "array", "number", "number", "number"], [signLevel, refNamesString, asicData, asicData.length, pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCVerifyData: function (signIndex, asicData) {
            ...
            try {
                error = Module.ccall("EUASiCVerifyData", "number", ["number", "array", "number", "number"], [signIndex, asicData, asicData.length, infoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            try {
                signTimeInfo = this.ASiCGetSignTimeInfo(signIndex, asicData);
            } catch (e) {
                infoPtr.free();
                throw e;
            }
        ...
        CtxASiCSignData: function (pkContext, signAlgo, asicType, signType, signLevel, references, asBase64String) {
            var refNames = [];
            var refData = [];
            var refDataSize = 0;
            for (var i = 0; i < references.length; i++) {
            ...
            var pPtr = EUPointerArray(pkContext.GetContext());
            var error;
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "number", "number", "number", "number", "array", "number", "number", "number", "number"],
                    [pkContext.GetContext(), signAlgo, asicType, signType, signLevel, refNamesString, refDataArray.arraysPtr, refDataArray.arraysLengthPtr, pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxASiCAppendSign: function (pkContext, signAlgo, signLevel, referencesNames, asicData, asBase64String) {
            this.CheckMaxDataSize(asicData);
            ...
            try {
                error = Module.ccall(
                    "EUCtxASiCAppendSign",
                    "number",
                    ["number", "number", "number", refNamesString ? "array" : "number", "array", "number", "number", "number"],
                    [pkContext.GetContext(), signAlgo, signLevel, refNamesString, asicData, asicData.length, pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCGetSignLevel: function (signIndex, asicData) {
            ...
            try {
                error = Module.ccall("EUASiCGetSignLevel", "number", ["number", "array", "number", "number"], [signIndex, asicData, asicData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxASiCGetSignerInfo: function (context, signIndex, asicData) {
            ...
            try {
                error = Module.ccall(
                    "EUCtxASiCGetSignerInfo",
                    "number",
                    ["number", "number", "array", "number", "number", "number", "number"],
                    [context.GetContext(), signIndex, asicData, asicData.length, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        ASiCIsAllContentCovered: function (signIndex, asicData) {
            ...
            try {
                error = Module.ccall("EUASiCIsAllContentCovered", "number", ["number", "array", "number", "number"], [signIndex, asicData, asicData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        PDFGetSignType: function (signIndex, signedPDFData) {
            ...
            if (typeof signedPDFData == "string") signedPDFData = this.Base64Decode(signedPDFData);

            var intPtr = EUPointerDWORD();
            var error;

            try {
                error = Module.ccall("EUPDFGetSignType", "number", ["number", "array", "number", "number"], [signIndex, signedPDFData, signedPDFData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        PDFGetSignsCount: function (signedPDFData) {
            ...
            try {
                error = Module.ccall("EUPDFGetSignsCount", "number", ["array", "number", "number"], [signedPDFData, signedPDFData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        PDFGetSignerInfo: function (signIndex, signedPDFData) {
            ...
            try {
                error = Module.ccall("EUPDFGetSignerInfo", "number", ["number", "array", "number", "number", "number", "number"], [signIndex, signedPDFData, signedPDFData.length, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxPDFGetSignerInfo: function (context, signIndex, signedPDFData) {
            ...
            try {
                error = Module.ccall(
                    "EUCtxPDFGetSignerInfo",
                    "number",
                    ["number", "number", "array", "number", "number", "number", "number"],
                    [context.GetContext(), signIndex, signedPDFData, signedPDFData.length, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        PDFGetSignTimeInfo: function (signIndex, signedPDFData) {
            ...
            try {
                error = Module.ccall("EUPDFGetSignTimeInfo", "number", ["number", "array", "number", "number"], [signIndex, signedPDFData, signedPDFData.length, pTimeInfoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        PDFSignData: function (pdfData, signType, asBase64String) {
            ...
            try {
                error = Module.ccall("EUPDFSignData", "number", ["array", "number", "number", "number", "number"], [pdfData, pdfData.length, signType, pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        PDFVerifyData: function (signIndex, signedPDFData) {
            ...
            try {
                error = Module.ccall("EUPDFVerifyData", "number", ["number", "array", "number", "number"], [signIndex, signedPDFData, signedPDFData.length, infoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            try {
                signTimeInfo = this.PDFGetSignTimeInfo(signIndex, signedPDFData);
            } catch (e) {
                infoPtr.free();
                throw e;
            }
        ...
        CtxPDFSignData: function (pkContext, signAlgo, pdfData, signType, asBase64String) {
            this.CheckMaxDataSize(pdfData);
            ...
            try {
                error = Module.ccall("EUCtxPDFSignData", "number", ["number", "number", "array", "number", "number", "number", "number"], [pkContext.GetContext(), signAlgo, pdfData, pdfData.length, signType, pPtr.ptr, pPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        XAdESGetType: function (xadesData) {
            ...
            if (typeof xadesData == "string") xadesData = this.Base64Decode(xadesData);

            var intPtr = EUPointerDWORD();
            var error;

            try {
                error = Module.ccall("EUXAdESGetType", "number", ["array", "number", "number"], [xadesData, xadesData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        XAdESGetSignsCount: function (xadesData) {
            ...
            try {
                error = Module.ccall("EUXAdESGetSignsCount", "number", ["array", "number", "number"], [xadesData, xadesData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        XAdESGetSignLevel: function (signIndex, xadesData) {
            ...
            try {
                error = Module.ccall("EUXAdESGetSignLevel", "number", ["number", "array", "number", "number"], [signIndex, xadesData, xadesData.length, intPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        XAdESGetSignerInfo: function (signIndex, xadesData) {
            ...
            try {
                error = Module.ccall("EUXAdESGetSignerInfo", "number", ["number", "array", "number", "number", "number", "number"], [signIndex, xadesData, xadesData.length, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        XAdESGetSignTimeInfo: function (signIndex, xadesData) {
            ...
            try {
                error = Module.ccall("EUXAdESGetSignTimeInfo", "number", ["number", "array", "number", "number"], [signIndex, xadesData, xadesData.length, pTimeInfoPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        XAdESGetSignReferences: function (signIndex, xadesData) {
            ...
            try {
                error = Module.ccall("EUXAdESGetSignReferences", "number", ["number", "array", "number", "number"], [signIndex, xadesData, xadesData.length, pPtr.ptr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        XAdESGetReference: function (xadesData, referenceName) {
            ...
            try {
                error = Module.ccall("EUXAdESGetReference", "number", ["array", "number", "array", "number", "number"], [xadesData, xadesData.length, this.fieldsEncoder.encode(referenceName), arrPtr.ptr, arrPtr.lengthPtr]);
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        XAdESSignData: function (xadesType, signLevel, references, asBase64String) {
            var refNames = [];
            var refData = [];
            var refDataSize = 0;
            for (var i = 0; i < references.length; i++) {
            ...
            try {
                error = Module.ccall(
                    ...
                    "number",
                    ["number", "number", "array", "number", "number", "number", "number"],
                    [xadesType, signLevel, refNamesString, refDataArray.arraysPtr, refDataArray.arraysLengthPtr, pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        XAdESVerifyData: function (references, signIndex, xadesData) {
            ...
            if (references != null) {
                ...
                refNamesString = intArrayFromStrings(refNames, this.fieldsEncoder);
            ...
            try {
                error = Module.ccall(
                    "EUXAdESVerifyData",
                    "number",
                    [refNamesString != null ? "array" : "number", "number", "number", "number", "array", "number", "number"],
                    [refNamesString, refDataArray != null ? refDataArray.arraysPtr : 0, refDataArray != null ? refDataArray.arraysLengthPtr : 0, signIndex, xadesData, xadesData.length, infoPtr.ptr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
            ...
            try {
                signTimeInfo = this.XAdESGetSignTimeInfo(signIndex, xadesData);
            } catch (e) {
                infoPtr.free();
                throw e;
            }
        ...
        CtxXAdESSignData: function (pkContext, signAlgo, xadesType, signLevel, references, asBase64String) {
            var refNames = [];
            var refData = [];
            var refDataSize = 0;
            for (var i = 0; i < references.length; i++) {
            ...
            try {
                error = Module.ccall(
                    "EUCtxXAdESSignData",
                    "number",
                    ["number", "number", "number", "number", "array", "number", "number", "number", "number"],
                    [pkContext.GetContext(), signAlgo, xadesType, signLevel, refNamesString, refDataArray.arraysPtr, refDataArray.arraysLengthPtr, pPtr.ptr, pPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
        ...
        CtxXAdESGetSignerInfo: function (context, signIndex, xadesData) {
            ...
            try {
                error = Module.ccall(
                    "EUCtxXAdESGetSignerInfo",
                    "number",
                    ["number", "number", "array", "number", "number", "number", "number"],
                    [context.GetContext(), signIndex, xadesData, xadesData.length, pCertInfoExPtr.ptr, certArrPtr.ptr, certArrPtr.lengthPtr]
                );
            } catch (e) {
                error = EU_ERROR_UNKNOWN;
            }
